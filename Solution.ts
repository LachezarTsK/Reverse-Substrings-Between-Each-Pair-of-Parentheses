...
function createReverseParentheses(input: string[]): string {
...
function reverse(start: number, end: number, input: string[]): void {
    while (start <= end) {
...
function swap(first: number, second: number, input: string[]): void {
